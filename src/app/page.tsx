...
import { algorithmOptions } from "../lib/uitils";
    ...
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#150229_1px)] bg-[size:40px_40px]">
      <div className="flex h-full justify-center">
        <div
          ...
          className="flex max-w-[1020] w-full flex-col lg:px-0 px-4"
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Select
                ...
                isDisabled={isSorting}
              />
              <button className="flext items-center justify-center" onClick={() => {}}>
                {requiresReset ? (
